    ...
    <section id="contact" className="section-padding">
      <div className="container-custom" ref={ref}>
        <motion.div 
          ...
          transition={{ duration: 0.5 }}
        >
          <p className="text-primary-400 font-medium mb-2">Get In Touch</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          >
            <h3 className="heading-sm mb-6 text-white">Let's Talk</h3>
            ...
            <motion.div className="space-y-6" variants={containerVariants}>
              <motion.div className="flex items-start space-x-4" variants={itemVariants}>
                <div className="p-3 rounded-full bg-dark-700 text-primary-400">
                  <Mail size={20} />
                </div>
                <div>
            ...
            <div className="card">
              {!submitted ? (
                ...
                <motion.div 
                  ...
                  transition={{ duration: 0.5 }}
                >
                  <div className="p-4 rounded-full bg-primary-500/20 mx-auto w-16 h-16 flex items-center justify-center mb-4">
